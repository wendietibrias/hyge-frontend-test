...
const Footer = () => {
    return (
        <footer className="w-full   border-top border-white/10 py-10  z-[999] sm:px-5">
            <div className="flex items-start gap-x-14 sm:w-full max-w-[1300px] mx-auto sm:flex-col sm:gap-y-8">
