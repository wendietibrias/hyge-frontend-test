...
const HeroSection = () => {
    return (
        <section className="sm:w-full py-16 sm:pt-16 sm:pb-10 max-w-[650px]">
            ...
            <p className="text-description text-[18px]  sm:text-[14px] sm:mt-6 mt-10 mb-8">As your digital partner, we collaborate with you to drive innovation, stay ahead of the curve, and deliver real impact for your business.</p>
