...
const HeroDetailSection = () => {
  return (
    <section className="w-full pb-10 mt-10">
        <div className="w-full relative h-[550px] xs:h-[200px]">
           <Image src="/static/assets/images/detail-image.png" alt="portfolio-1" fill className="rounded-xl object-cover xs:object-contain"/>
        </div>
        <div className="mt-10 flex items-center gap-x-12 xs:flex-col xs:items-start xs:gap-y-7">
