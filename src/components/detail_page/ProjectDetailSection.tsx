...
const ProjectDetailSection = () => {
  return (
    <section className="w-full py-16">
        <h1 className="text-5xl font-bold text-secondary-alt xs:text-[32px]">Levare Decanter</h1>
        <p className="text-[16px] xs:text-[14px] text-description mt-10">
        ...
        <div className="py-16 border-b border-white/10">
            ...
            <div className="rounded-xl mb-10 mt-7 xs:grid-cols-2 xs:gap-y-5 grid grid-cols-4 gap-x-5 border border-white/10 p-3">
        ...
        <div className="w-full xs:py-10 py-12">
        ...
        <div className="w-full xs:py-6 py-12">
